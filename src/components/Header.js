            ...
            <div className="relative z-10">
                <div className="relative text-center mb-8">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 w-64 h-0.5 mt-2">
                        <div
                            className="h-full bg-gradient-to-r from-transparent via-asgard-gold to-transparent animate-pulse"/>
                    </div>
                </div>

                <nav className="relative mt-12 py-4 flex justify-center items-center gap-8">
                    <div
                        className="absolute left-0 top-1/2 -translate-y-1/2 w-16 h-px bg-gradient-to-r from-transparent to-asgard-gold animate-pulse"/>
                    ...
                    <div
                        className="absolute right-0 top-1/2 -translate-y-1/2 w-16 h-px bg-gradient-to-l from-transparent to-asgard-gold animate-pulse"/>
                </nav>
            </div>
        </header>
    </LazyBackground>
